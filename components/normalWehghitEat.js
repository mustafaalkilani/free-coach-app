...
const NormalWeight = ({ day }) => {
  ...
  useEffect(() => {
    const initializeFirebase = async () => {
      ...
      const docRef = db.collection("NormalWeight").doc(`day : ${day}`);
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>خطة غذائية للأشخاص الطبيعيين</Text>
      {isLoading ? (
...
const NormalWehghitOne = () => {
  return <NormalWeight day={"الاحد"} />;
};

const NormalWehghitTwo = () => {
  return <NormalWeight day={"الاثنين"} />;
};

const NormalWehghitThree = () => {
  return <NormalWeight day={"الثلاثاء"} />;
};

const NormalWehghitFour = () => {
  return <NormalWeight day={"الاربعاء"} />;
};

const NormalWehghitFive = () => {
  return <NormalWeight day={"الخميس"} />;
};

const NormalWehghitSix = () => {
  return <NormalWeight day={"الجمعة"} />;
};

const NormalWehghitSeven = () => {
  return <NormalWeight day={"السبت"} />;
};
