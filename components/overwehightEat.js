...
const OverWeight = ({ day }) => {
  ...
  useEffect(() => {
    const initializeFirebase = async () => {
      ...
      const docRef = db.collection("OverWeight").doc(`day : ${day}`);
...
const OverWehghitOne = () => {
  return <OverWeight day={"الاحد"} />;
};

const OverWehghitTwo = () => {
  return <OverWeight day={"الاثنين"} />;
};

const OverWehghitThree = () => {
  return <OverWeight day={"الثلاثاء"} />;
};

const OverWehghitFour = () => {
  return <OverWeight day={"الاربعاء"} />;
};

const OverWehghitFive = () => {
  return <OverWeight day={"الخميس"} />;
};

const OverWehghitSix = () => {
  return <OverWeight day={"الجمعة"} />;
};

const OverWehghitSeven = () => {
  return <OverWeight day={"السبت"} />;
};
